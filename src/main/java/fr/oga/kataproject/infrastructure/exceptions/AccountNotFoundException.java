...
public class AccountNotFoundException extends AbstractEntityException {
    public AccountNotFoundException(String message , ErrorCodes errorCodes , List<String> errors){
        super(message,errorCodes,errors);
    }

    public AccountNotFoundException(String message , ErrorCodes errorCodes){
